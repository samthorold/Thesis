...
Popular asset-pricing models\footnote{Such as the three-factor model of 
  \cite{fama1993common}, the four factor model of \cite{hou2015digesting}, the 
  five-factor model of \cite{fama2015five} and the cash profitability 
  five-factor model of \cite{fama2016choosing}} omit the momentum factor, 
despite 
momentum's persistence as an anomaly (\cite{fama2016dissecting, 
